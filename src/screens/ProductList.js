    ...
    if (item.id === 1) {
      ...
      return (
        <View style={styles.rowContainer}>
          <View style={styles.cell}><Text>{item.id}</Text></View>
          <View style={styles.cell}><Text>{item.name}</Text></View>
          <View style={styles.cell}><Text>{item.qty}</Text></View>
    ...
    <FlatList
      ...
      ListFooterComponent={() => (
        <>
          ...
          <Button title="Generate Bill Summary" onPress={generateBillSummary} />
        </>
      )}
    />
  </View>
